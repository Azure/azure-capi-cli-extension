...
# Install azdev for azure CLI and extension development
COPY .devcontainer/library-scripts/azdev-setup.sh /tmp/library-scripts/
RUN bash /tmp/library-scripts/azdev-setup.sh "${PIPX_HOME}" \
